...
import { Pencil, Trash2, Calendar, Home, Phone, User as UserIcon, MoreHorizontal } from 'lucide-react'
      ...
      <div className="flex justify-between items-start mb-6 relative z-10">
        ...
        <div className="flex gap-1 bg-slate-50 p-1 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          ...
          <Button
            size="icon"
            variant="ghost"
            className="w-8 h-8 rounded-lg hover:bg-white hover:text-rose-600 shadow-sm text-slate-400"
            onClick={(e) => {
              e.stopPropagation()
