      ...
      <DialogContent className="min-w-4xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
            ...
            <div className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-1">
                    ...
                    <Input type="date" name="startDate" value={form.startDate} onChange={handleChange} className="bg-slate-50/50" />
                  </div>
                  <div className="space-y-1">
                    <Label className="text-[10px] text-slate-400">Đến ngày</Label>
                    <Input type="date" name="endDate" value={form.endDate} onChange={handleChange} className="bg-slate-50/50" />
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input name="note" value={form.note} onChange={handleChange} placeholder="Điều kiện bổ sung..." />
              </div>
            </div>
          </div>
        )}
        ...
        <DialogFooter className="mt-8 pt-4 border-t flex flex-row items-center justify-between">
          <div className="flex gap-2">
             {mode !== 'create' && (
              <Button variant="destructive" onClick={() => handleSubmit(true)} className="px-6">
                Xóa hợp đồng
              </Button>
            )}
          ...
          {mode !== 'delete' && (
            <Button onClick={() => handleSubmit()} className="min-w-[140px] bg-blue-600 hover:bg-blue-700 shadow-md shadow-blue-200">
