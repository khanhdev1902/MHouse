...
export default function ChatPage() {
  ...
  return (
    <div className='flex h-[550px] max-h-[550px] w-full mx-auto bg-white rounded-2xl shadow-lg border border-slate-100 overflow-hidden'>
      {/* --- SIDEBAR BÊN TRÁI --- */}
                ...
                <div className='flex justify-between items-center mb-0.5'>
                  <p
                    className={cn(
                      ...
                      activeGroup === group.id ? 'text-main' : 'text-slate-800'
                    )}
                  >
                    {group.name}
                  </p>
